...
//The reason why the nested function nestedFunction()
 //can access the variable internal declared in its parent function
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals) {
    ...
    zooAnimals.forEach(animal => {
      ...
      let scientificName = animal.scientific_name;
      let displayName = `name: ${animalName}, scientific: ${scientificName}`;
  ...
  */
  function lowerCaseNames(zooAnimals) {
    let lowerCaseNames = zooAnimals.map(animal => animal.animal_name.toLowerCase());
  ...
  */
  ...
  function USApop(zooAnimals) {
    let totalPopulation = zooAnimals.reduce((accumulator, animal) => {
